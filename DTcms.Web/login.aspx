<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="DTcms.Web.login" %>
...
<div class="copy-right">
  <p>版权所有 深圳市动力启航软件有限公司 Copyright © 2009 - 2015 dtsoft.net Inc. All Rights Reserved. <asp:Label ID="q" runat="server" Text="Label"></asp:Label></p>
</div>
</form>
</body>
</html>
