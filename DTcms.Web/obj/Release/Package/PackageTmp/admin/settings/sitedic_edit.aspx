<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sitedic_edit.aspx.cs" Inherits="DTcms.Web.admin.settings.sitedic_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="site_dic.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="site_dic.aspx"><span>字典管理</span></a>
            <i class="arrow"></i>
            <span>编辑字典</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*中文名称，200字符内</span></dd>
            </dl>
            <dl>
                <dt>备注说明</dt>
                <dd>
