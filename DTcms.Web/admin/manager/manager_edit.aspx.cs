...
namespace DTcms.Web.admin.manager
{
    public partial class manager_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            Model.dt_manager_info mll = new BLL.dt_manager_info().GetModelId(model.id);
        ...
        private bool DoAdd()
        {
            ...
            BLL.manager bll = new BLL.manager();
            Model.dt_manager_info minfo= new Model.dt_manager_info();
            BLL.dt_manager_info mll=new BLL.dt_manager_info();
            ...
            var mid = bll.Add(model);
            minfo.avatar = txtAvatar.Text;
            minfo.mid = mid;
            minfo.name = txtRealName.Text;
            minfo.sign = txtQm.Text;
            var mi= mll.Add(minfo);
            if (mid > 0 && mi>0)
            {
        ...
        private bool DoEdit(int _id)
        {
            ...
            minfo.sign = txtQm.Text;
            var mi = mll.Add(minfo);
            if (bll.Update(model)&&mll.Update(minfo))
            {
