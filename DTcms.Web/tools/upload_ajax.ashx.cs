...
namespace DTcms.Web.tools
{
    ...
    public class upload_ajax : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (action)
            {
                ...
                case "ManagerFile": //管理文件
                    ManagerFile(context);
                    break;
                case "UpLoadFileIm": //管理文件
                    UpLoadFileIm(context);
                    break;
                default: //普通上传
                    UpLoadFile(context);
                    break;
        ...
        #region IM上传图片处理===================================
        private void UpLoadFileIm (HttpContext context)
            {
            ...
            string msg = upFiles.fileSaveAsIm(_upfile, _isthumbnail, _iswater, type);
